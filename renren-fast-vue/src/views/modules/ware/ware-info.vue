<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="address" header-align="center" align="center" label="Address">
      </el-table-column>
      <el-table-column prop="areaCode" header-align="center" align="center" label="Area Code">
      </el-table-column>
